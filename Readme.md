...
- <b>ANN</b>: the final layer of the network is the <b><u>Dense layer</u></b>, i.e. the fully (or <i>densely</i>) connected layer, where each neuron is connected to (receives input from) all the neurons of the preceding layer.
